...
/**
 * OrderWithIncludesProductsInnerWarehouse Class Doc Comment
 *
 * @category Class
 * @description Інформація про склад відвантаження товару. Повертається тільки якщо &#x60;shipment_type &#x3D;&#x3D;&#x3D; warehouse&#x60;
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderWithIncludesProductsInnerWarehouse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithIncludes_products_inner_warehouse';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Ідентифікатор складу
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Назва складу
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Опис складу
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Ознака того, чи активний склад
     *
     * @return self
     */
