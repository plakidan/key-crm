...
/**
 * OrderWithIncludesAssignedInnerRole Class Doc Comment
 *
 * @category Class
 * @description Інформація про роль користувача
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrderWithIncludesAssignedInnerRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithIncludes_assigned_inner_role';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID ролі користувача
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Назва ролі користувача
     *
     * @return self
     */
     ...
     * Sets alias
     *
     * @param string|null $alias Аліас ролі користувача
     *
     * @return self
     */
