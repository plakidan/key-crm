...
/**
 * CreateNewCategoryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewCategoryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewCategory_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Назва категорії
     *
     * @return self
     */
     ...
     * Sets parent_id
     *
     * @param int|null $parent_id Ідентифікатор батьківської категорії, якщо створюєте підкатегорію.
     *
     * @return self
     */
