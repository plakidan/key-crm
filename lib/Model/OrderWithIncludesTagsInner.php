...
/**
 * OrderWithIncludesTagsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderWithIncludesTagsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithIncludes_tags_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id Ідентифікатор тегу
     *
     * @return self
     */
     ...
     * Sets color
     *
     * @param string|null $color Колір тегу в форматі HEX
     *
     * @return self
     */
