...
class Status implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param int|null $expiration_period Максимальний термін перебування замовлення в статусі, після якого воно вважається протермінованим, в секундах
     *
     * @return self
     */
     ...
     * Sets deleted_at
     *
     * @param string|null $deleted_at Дата видалення в UTC форматі
     *
     * @return self
     */
