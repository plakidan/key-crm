...
/**
 * ImportBuyersRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImportBuyersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'importBuyers_request';
    ...
    protected static $openAPITypes = [
        'buyers' => '\OpenAPI\Client\Model\ImportBuyersRequestBuyersInner[]'
    ];
    ...
    */
     ...
     * Gets buyers
     *
     * @return \OpenAPI\Client\Model\ImportBuyersRequestBuyersInner[]
     */
     ...
     * Sets buyers
     *
     * @param \OpenAPI\Client\Model\ImportBuyersRequestBuyersInner[] $buyers buyers
     *
     * @return self
     */
    ...
    {
        if (is_null($buyers)) {
            throw new \InvalidArgumentException('non-nullable buyers cannot be null');
        }
