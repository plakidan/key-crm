...
/**
 * OrderWithIncludesExpensesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderWithIncludesExpensesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithIncludes_expenses_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID витрати в KeyCRM
     *
     * @return self
     */
     ...
     *
     * @param int|null $expense_type_id ID типу витрати в KeyCRM
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param float|null $amount Сума витрати
     *
     * @return self
     */
     ...
     *
     * @param string|null $actual_currency Валюта витрати
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_uuid ID зовнішньої транзакції зв'язаної з витратою
     *
     * @return self
     */
