...
/**
 * OffersUpdateRequestOffersInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OffersUpdateRequestOffersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'offersUpdate_request_offers_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id ID варіанту товару у KeyCRM
     *
     * @return self
     */
