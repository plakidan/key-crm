...
/**
 * CreateNewPipelineCardRequestCustomFieldsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewPipelineCardRequestCustomFieldsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewPipelineCard_request_custom_fields_inner';
    ...
    */
     ...
     * Sets value
     *
     * @param string|null $value Значення поля. Для полів з типом `select (список/мультисписок)` передавати масив рядків.
     *
     * @return self
     */
