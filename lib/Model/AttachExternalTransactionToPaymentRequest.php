...
/**
 * AttachExternalTransactionToPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AttachExternalTransactionToPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'attachExternalTransactionToPayment_request';
    ...
    */
     ...
     * Sets transaction_id
     *
     * @param float|null $transaction_id ID зовнішньої транзакції
     *
     * @return self
     */
     ...
     *
     * @param string|null $transaction_uuid Зовнішній ідентифікатор зовнішньої транзакції
     *
     * @return self
     */
