...
/**
 * CompanyWithIncludes Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CompanyWithIncludes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CompanyWithIncludes';
    ...
    protected static $openAPITypes = [
        ...
        'bank_account' => 'string',
        'manager_id' => 'int',
        'manager' => '\OpenAPI\Client\Model\CompanyWithIncludesManager',
    ...
    */
     ...
     * Gets manager
     *
     * @return \OpenAPI\Client\Model\CompanyWithIncludesManager|null
     */
     ...
     * Sets manager
     *
     * @param \OpenAPI\Client\Model\CompanyWithIncludesManager|null $manager manager
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param \OpenAPI\Client\Model\OrderWithIncludesCustomFieldsInner[]|null $custom_fields Користувацькі поля в компангії. Повертаються тільки заповнені, якщо вказати `include=custom_fields`
     *
     * @return self
     */
