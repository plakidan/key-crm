...
/**
 * CreateNewOrderPaymentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewOrderPaymentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewOrderPayment_request';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('status', $data ?? [], 'paid');
