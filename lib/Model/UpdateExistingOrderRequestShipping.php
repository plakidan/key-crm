...
/**
 * UpdateExistingOrderRequestShipping Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateExistingOrderRequestShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateExistingOrder_request_shipping';
    ...
    */
    ...
    public function setShippingSecondaryLine($shipping_secondary_line)
    {
        if (is_null($shipping_secondary_line)) {
            array_push($this->openAPINullablesSetToNull, 'shipping_secondary_line');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipping_secondary_line', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
