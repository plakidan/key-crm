...
/**
 * CreateNewOrderExpenseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewOrderExpenseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewOrderExpense_request';
    ...
    */
     ...
     *
     * @param int|null $expense_type_id ID типу витрати в KeyCRM, обов'язковий параметр, якщо `expense_type` не заданий
     *
     * @return self
     */
     ...
     * Sets expense_type
     *
     * @param string|null $expense_type Назва типу витрати, обов'язковий параметр, якщо `expense_type_id` не заданий
     *
     * @return self
     */
     ...
     * Sets payment_date
     *
     * @param string|null $payment_date Дата і час витрати. Якщо не передається, буде використаний поточний час
     *
     * @return self
     */
