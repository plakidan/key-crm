...
/**
 * OrderWithIncludesShipping Class Doc Comment
 *
 * @category Class
 ...
 */
class OrderWithIncludesShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithIncludes_shipping';
    ...
    protected static $attributeMap = [
        ...
        'shipping_date_actual' => 'shipping_date_actual'
    ];
    ...
    protected static $setters = [
        ...
        'shipping_date_actual' => 'setShippingDateActual'
    ];
    ...
    protected static $getters = [
        ...
        'shipping_date_actual' => 'getShippingDateActual'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('shipping_date_actual', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $delivery_service_id ID служби доставки в KeyCRM
     *
     * @return self
     */
     ...
     * Sets tracking_code
     *
     * @param string|null $tracking_code Трекінг-код замовлення
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_status Статус доставки замовлення
     *
     * @return self
     */
    public function setShippingStatus($shipping_status)
    {
        if (is_null($shipping_status)) {
            array_push($this->openAPINullablesSetToNull, 'shipping_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shipping_status', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $shipping_address_city Місто доставки
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_address_country Країна доставки
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_address_country_code Код країни доставки
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_address_zip Індекс
     *
     * @return self
     */
     ...
     *
     * @param string|null $shipping_secondary_line Додаткова адреса
     *
     * @return self
     */
    ...
    /**
     * Gets shipping_date_actual
     *
     * @return string|null
     */
    public function getShippingDateActual()
    {
        return $this->container['shipping_date_actual'];
    }

    /**
     * Sets shipping_date_actual
     *
     * @param string|null $shipping_date_actual Дата доставки / відправки
     *
     * @return self
     */
    public function setShippingDateActual($shipping_date_actual)
    {
        if (is_null($shipping_date_actual)) {
            throw new \InvalidArgumentException('non-nullable shipping_date_actual cannot be null');
        }
        $this->container['shipping_date_actual'] = $shipping_date_actual;
