...
/**
 * UpdateExistingOrderExpenseRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpdateExistingOrderExpenseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateExistingOrderExpense_request';
    ...
    */
     ...
     * Sets status
     *
     * @param string|null $status Статус витрати
     *
     * @return self
     */
