...
/**
 * CustomFieldOptionsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CustomFieldOptionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomField_options_inner';
    ...
    */
     ...
     * Sets field_id
     *
     * @param int|null $field_id ID поля в системі до якого відноситься опція
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Назва опції
     *
     * @return self
     */
