...
/**
 * CreateNewOrderRequestShipping Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateNewOrderRequestShipping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'createNewOrder_request_shipping';
    ...
    */
     ...
     *
     * @param string|null $shipping_service Назва служби доставки
     *
     * @return self
     */
