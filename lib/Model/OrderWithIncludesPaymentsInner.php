...
/**
 * OrderWithIncludesPaymentsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OrderWithIncludesPaymentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderWithIncludes_payments_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fiscal_result', $data ?? [], null);
    ...
    */
     ...
     * Sets destination_id
     *
     * @param int|null $destination_id ID замовлення в KeyCRM
     *
     * @return self
     */
     ...
     * @return object|null
     */
    public function getFiscalResult()
    {
        return $this->container['fiscal_result'];
    }

    /**
     * Sets fiscal_result
     *
     * @param object|null $fiscal_result Інформація про результат фіскалізації платежу
     *
     * @return self
     */
    public function setFiscalResult($fiscal_result)
    {
        if (is_null($fiscal_result)) {
            array_push($this->openAPINullablesSetToNull, 'fiscal_result');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fiscal_result', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['fiscal_result'] = $fiscal_result;
