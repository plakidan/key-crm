...
/**
 * OffersStocksUpdateRequestStocksInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OffersStocksUpdateRequestStocksInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'offersStocksUpdate_request_stocks_inner';
    ...
    */
     ...
     * Sets quantity
     *
     * @param float $quantity Кількість одиниць на складі
     *
     * @return self
     */
