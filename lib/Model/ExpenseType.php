 ...
 */
class ExpenseType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExpenseType';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('by_order', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets id
     *
     * @param int $id ID типу витрати у KeyCRM
     *
     * @return self
     */
     ...
     * Sets is_active
     *
     * @param bool|null $is_active Статус типу витрати
     *
     * @return self
     */
     ...
     * Sets is_reserved
     *
     * @param bool|null $is_reserved Зарезервовано системою
     *
     * @return self
     */
    ...
    {
        return $this->container['by_order'];
    }

    /**
     * Sets by_order
     *
     * @param bool|null $by_order Чи використовувати цей тип витрати для замовлень?
     *
     * @return self
     */
    public function setByOrder($by_order)
    {
        if (is_null($by_order)) {
            throw new \InvalidArgumentException('non-nullable by_order cannot be null');
        }
        $this->container['by_order'] = $by_order;
