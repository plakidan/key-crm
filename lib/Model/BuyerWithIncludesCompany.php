...
/**
 * BuyerWithIncludesCompany Class Doc Comment
 *
 * @category Class
 ...
 */
class BuyerWithIncludesCompany implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BuyerWithIncludes_company';
    ...
    protected static $attributeMap = [
        ...
        'full_name' => 'full_name',
        'address' => 'address',
        'banking_detailse' => 'banking_detailse',
        'note' => 'note',
    ...
    protected static $setters = [
        ...
        'address' => 'setAddress',
        'banking_detailse' => 'setBankingDetailse',
        'note' => 'setNote',
    ...
    protected static $getters = [
        ...
        'address' => 'getAddress',
        'banking_detailse' => 'getBankingDetailse',
        'note' => 'getNote',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('banking_detailse', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Назва компанії
     *
     * @return self
     */
     ...
     * Sets full_name
     *
     * @param string|null $full_name Пона назва компанії
     *
     * @return self
     */
     ...
     * Sets address
     *
     * @param string|null $address Адресса компанії
     *
     * @return self
     */
    ...
    /**
     * Gets banking_detailse
     *
     * @return string|null
     */
    public function getBankingDetailse()
    {
        return $this->container['banking_detailse'];
    }

    /**
     * Sets banking_detailse
     *
     * @param string|null $banking_detailse Банківскі деталі
     *
     * @return self
     */
    public function setBankingDetailse($banking_detailse)
    {
        if (is_null($banking_detailse)) {
            array_push($this->openAPINullablesSetToNull, 'banking_detailse');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('banking_detailse', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['banking_detailse'] = $banking_detailse;
