...
/**
 * OffersStocksUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class OffersStocksUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'offersStocksUpdate_request';
    ...
    protected static $openAPITypes = [
        'warehouse_id' => 'int',
        'stocks' => '\OpenAPI\Client\Model\OffersStocksUpdateRequestStocksInner[]'
    ];
    ...
    */
     ...
     * Sets warehouse_id
     *
     * @param int $warehouse_id Ідентифікатор складу. Обов'язкове поле
     *
     * @return self
     */
     ...
     * Gets stocks
     *
     * @return \OpenAPI\Client\Model\OffersStocksUpdateRequestStocksInner[]
     */
     ...
     * Sets stocks
     *
     * @param \OpenAPI\Client\Model\OffersStocksUpdateRequestStocksInner[] $stocks stocks
     *
     * @return self
     */
