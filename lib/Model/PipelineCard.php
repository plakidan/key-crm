...
/**
 * PipelineCard Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PipelineCard implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PipelineCard';
    ...
    */
     ...
     * Sets contact_id
     *
     * @param int $contact_id Ідентифікатор контактної особи картки воронки
     *
     * @return self
     */
