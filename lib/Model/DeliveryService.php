...
class DeliveryService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int $id Ідентифікатор служби доставки
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Назва служби доставки
     *
     * @return self
     */
     ...
     * Sets source_name
     *
     * @param string|null $source_name Служба доставки, з якою пов'язаний метод
     *
     * @return self
     */
